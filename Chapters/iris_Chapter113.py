...
""" 11.3. Deriving Exner Pressure and Air Temperature
Examples from http://scitools.org.uk/iris/docs/latest/userguide 

This example shows some processing of cubes in order to derive further
related cubes; in this case the derived cubes are Exner pressure and
air temperature which are calculated by combining air pressure, air
potential temperature amd specific humidity. Finally, the two cubes
are presented side-by-side in a plot.
